...
FROM
    employees e
JOIN
    department_manager de ON e.emp_no::integer = de.emp_no   
JOIN  
...
FROM
    employees e
JOIN
    departments ON de.dept_no = d.dept_no
JOIN dept_emp ON e.ept_no = de.emp_no;
